...
def test_login_invalid_credentials(mock_sigaa_client_class, client):
    ...
    response = client.post("/auth/sigaa", json={"registration": "190012345", "password": "wrong"})
...
def test_login_success_sets_cookies(mock_sigaa_client_class, client):
    ...
    response = client.post("/auth/sigaa", json={"registration": "190012345", "password": "correct_password"})
